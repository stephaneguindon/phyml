...
# if defined (MIGREP)
  ...
  mcmc->move_weight[mcmc->num_move_migrep_indel_hit]             = 2.0;
...
void MCMC_MIGREP_Scale_Times(t_tree *tree)
{
  ...
  */
  ...
  /* mean = n_tot_disks/FABS(newT); */
  /* sd   = 0.2*n_tot_disks/FABS(newT); */
  /* new_lbda = Rnorm_Trunc(mean,sd, */
  /*                        tree->mmod->min_lbda, */
  /*                        mean + 3.*sd, */
  /*                        &err); */
  
  /* mean = n_tot_disks/FABS(curT); */
  /* sd   = 0.2*n_tot_disks/FABS(curT); */
  /* hr += Log_Dnorm_Trunc(cur_lbda, */
  /*                       mean,sd, */
  /*                       tree->mmod->min_lbda, */
  /*                       mean + 3.*sd, */
