...
# if defined (PHYREX)
  ...
  mcmc->move_weight[mcmc->num_move_phyrex_spr_slide]             = 1.0;
              ...
              do
                {
                  ...
                  /* PhyML_Printf("\n. neff %15f %15f %15f %25s",aux_tree->mmod->c_lnL,aux_tree->times->c_lnL,aux_tree->n_root->ldsk->disk->time,tree->mcmc->move_name[move]); */
