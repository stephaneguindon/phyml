...
# if defined (PHYREX)
  ...
  mcmc->move_weight[mcmc->num_move_phyrex_sigsq]                 = 0.5;
  mcmc->move_weight[mcmc->num_move_time_neff]                    = 0.5;
  mcmc->move_weight[mcmc->num_move_time_exp_growth]              = 0.5;
  mcmc->move_weight[mcmc->num_move_phyrex_sigsq_scale]           = 0.5;
