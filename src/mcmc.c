...
void MCMC_Birth_Rate(t_tree *tree)
{
  ...
  /* new_birth_rate = -1.0; */
  /* ratio          =  0.0; */
  /* n_mcmc_steps   =  tree->mcmc->run_move[tree->mcmc->num_move_birth_rate] == 1 ? 10000 : 1000; */
  /* move           = -1; */
  ...
  /*     TIMES_Randomize_Tree_With_Time_Constraints(tree->ghost_tree->rates->a_cal[0],tree->ghost_tree); */
  ...
  /*         if(!strcmp(tree->mcmc->move_name[move],"spr_root"))    { MCMC_Prune_Regraft_Root(tree->ghost_tree); i++; } */
...
void MCMC_Death_Rate(t_tree *tree)
{
  ...
  /* new_death_rate = -1.0; */
  /* ratio          =  0.0; */
  /* n_mcmc_steps   =  tree->mcmc->run_move[tree->mcmc->num_move_death_rate] == 1 ? 10000 : 1000; */
  /* move           = -1; */
...
void MCMC_Prune_Regraft_Root(t_tree *tree)
{
  ...
  while(n_iter--)
    {
      tree->mcmc->run_move[tree->mcmc->num_move_spr_root]++;
      ...
      if(u > alpha)
        ...
        {
          tree->mcmc->acc_move[tree->mcmc->num_move_spr_root]++;
        }      
    }
}
...
void MCMC_Complete_MCMC(t_mcmc *mcmc, t_tree *tree)
{
  ...
  mcmc->move_weight[mcmc->num_move_spr_root]         = 2.0;
