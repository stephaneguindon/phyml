...
void CV_State_Probs_At_Hidden_Positions(phydbl **state_probs, short int **truth,
                                        ...
                                        int    *n_prob_vectors,
                                        t_tree *tree);
void CV_Hide_Characters_At_Random_Pos(calign *data, phydbl mask_prob);
void CV_Hide_Characters_At_Random_Col(calign *data, phydbl mask_prob);
void CV_Hide_Character_At_Given_Pos(calign *data, int tax_id, int site);
