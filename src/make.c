...
void Make_Tree_For_Lk(t_tree *tree)
{
  ...
  tree->site_lk_cat  = (phydbl *)mCalloc(
      MAX(tree->mod->ras->n_catg, tree->mod->n_mixt_classes), sizeof(phydbl));
  tree->unscaled_site_lk_cat = (phydbl *)mCalloc(
      MAX(tree->mod->ras->n_catg, tree->mod->n_mixt_classes) * tree->data->n_pattern,
      sizeof(phydbl));
  ...
  if (posix_memalign(
          (void **)&tree->expl, BYTE_ALIGN,
          (size_t)3 * MAX(tree->mod->ras->n_catg, tree->mod->n_mixt_classes) *
              tree->mod->ns * sizeof(phydbl)))
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
  if (posix_memalign((void **)&tree->p_lk_left_pi, BYTE_ALIGN,
                     (size_t)ns * sizeof(phydbl)))
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
  if (posix_memalign((void **)&tree->l_ev, BYTE_ALIGN,
                     (size_t)nsns * sizeof(phydbl)))
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
  if (posix_memalign((void **)&tree->_tPij1, BYTE_ALIGN,
                     (size_t)(ncatg * nsns / sz) * sizeof(__m256d)))
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
  if (posix_memalign((void **)&tree->_tPij2, BYTE_ALIGN,
                     (size_t)(ncatg * nsns / sz) * sizeof(__m256d)))
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
  if (posix_memalign((void **)&tree->_pmat1plk1, BYTE_ALIGN,
                     (size_t)ns / sz * sizeof(__m256d)))
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
  if (posix_memalign((void **)&tree->_pmat2plk2, BYTE_ALIGN,
                     (size_t)ns / sz * sizeof(__m256d)))
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
  if (posix_memalign((void **)&tree->_plk0, BYTE_ALIGN,
                     (size_t)(ns / sz) * sizeof(__m256d)))
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
  if (posix_memalign((void **)&tree->_l_ev, BYTE_ALIGN,
                     (size_t)nsns / sz * sizeof(__m256d)))
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
  if (posix_memalign((void **)&tree->_r_ev, BYTE_ALIGN,
                     (size_t)nsns / sz * sizeof(__m256d)))
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
  if (posix_memalign((void **)&tree->_prod_left, BYTE_ALIGN,
                     (size_t)ns / sz * sizeof(__m256d)))
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
  if (posix_memalign((void **)&tree->_prod_rght, BYTE_ALIGN,
                     (size_t)ns / sz * sizeof(__m256d)))
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
  if (posix_memalign(
          (void **)&tree->big_lk_array, BYTE_ALIGN,
          (size_t)((3 * tree->n_otu - 2) * tree->data->n_pattern *
                       MAX(tree->mod->ras->n_catg, tree->mod->n_mixt_classes) *
                       tree->mod->ns +
                   2 * (2 * tree->n_otu - 1) * tree->mod->ras->n_catg *
                       tree->mod->ns * tree->mod->ns) *
              sizeof(phydbl)))
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
#else
  tree->dot_prod = _aligned_malloc(
      tree->n_pattern * tree->mod->ns *
          ...
          sizeof(phydbl),
      BYTE_ALIGN);
  tree->expl = _aligned_malloc(
      3 * MAX(tree->mod->ras->n_catg, tree->mod->n_mixt_classes) *
          tree->mod->ns * sizeof(phydbl),
      BYTE_ALIGN);
  tree->p_lk_left_pi = _aligned_malloc(ns * sizeof(phydbl), BYTE_ALIGN);
  tree->l_ev         = _aligned_malloc(ns * ns * sizeof(phydbl), BYTE_ALIGN);
  tree->_tPij1 =
      _aligned_malloc(ncatg * nsns / sz * sizeof(__m256d), BYTE_ALIGN);
  tree->_tPij2 =
      _aligned_malloc(ncatg * nsns / sz * sizeof(__m256d), BYTE_ALIGN);
  ...
  tree->big_lk_array = _aligned_malloc(
      ((3 * tree->n_otu - 2) * tree->data->n_pattern *
           MAX(tree->mod->ras->n_catg, tree->mod->n_mixt_classes) *
           tree->mod->ns +
       2 * (2 * tree->n_otu - 1) * tree->mod->ras->n_catg * tree->mod->ns *
           tree->mod->ns) *
          sizeof(phydbl),
      BYTE_ALIGN);
#endif
  ...
  if (posix_memalign((void **)&tree->l_ev, BYTE_ALIGN,
    ...
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
  if (posix_memalign((void **)&tree->_tPij1, BYTE_ALIGN,
                     (size_t)(ncatg * nsns / sz) * sizeof(__m128d)))
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
  if (posix_memalign((void **)&tree->_tPij2, BYTE_ALIGN,
                     (size_t)(ncatg * nsns / sz) * sizeof(__m128d)))
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
  if (posix_memalign((void **)&tree->_pmat1plk1, BYTE_ALIGN,
                     (size_t)ns / sz * sizeof(__m128d)))
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
  if (posix_memalign((void **)&tree->_pmat2plk2, BYTE_ALIGN,
                     (size_t)ns / sz * sizeof(__m128d)))
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
  ...
  tree->l_ev         = _aligned_malloc(ns * ns * sizeof(phydbl), BYTE_ALIGN);
  tree->_tPij1 =
      _aligned_malloc(ncatg * nsns / sz * sizeof(__m128d), BYTE_ALIGN);
  tree->_tPij2 =
      _aligned_malloc(ncatg * nsns / sz * sizeof(__m128d), BYTE_ALIGN);
  ...
  tree->big_lk_array = (phydbl *)mCalloc(
      ((3 * tree->n_otu - 2) * tree->data->n_pattern *
           MAX(tree->mod->ras->n_catg, tree->mod->n_mixt_classes) *
           tree->mod->ns +
       2 * (2 * tree->n_otu - 1) * tree->mod->ras->n_catg * tree->mod->ns *
  ...
  if (tree->is_mixt_tree == NO)
  {
    for (i = 0; i < 2 * tree->n_otu - 1; ++i)
      Make_Edge_Lk(tree->a_edges[i], tree);
    for (i = 0; i < 2 * tree->n_otu - 2; ++i) Make_Node_Lk(tree->a_nodes[i]);
    for (i = 0; i < 2 * tree->n_otu - 1; ++i)
      Make_Edge_Loc(tree->a_edges[i], tree);
...
void Make_Tree_For_Pars(t_tree *tree)
{
  ...
  tree->site_pars = (int *)mCalloc(tree->data->n_pattern, sizeof(int));
  tree->step_mat  = (int *)mCalloc(tree->mod->ns * tree->mod->ns, sizeof(int));

  for (i = 0; i < 2 * tree->n_otu - 1; ++i)
    Make_Edge_Pars(tree->a_edges[i], tree);

  Init_Ui_Tips(tree);
  Init_Partial_Pars_Tips(
      tree); /* Must be called after Init_Ui_Tips is called */
...
void Make_All_Edges_Lk(t_node *a, t_node *d, t_tree *tree)
{
  ...
  for (i = 0; i < 3; i++)
    if ((a->v[i]) && (a->v[i] == d)) Make_Edge_Lk(a->b[i], tree);
...
t_edge *Make_Edge_Light(t_node *a, t_node *d, int num)
{
  ...
  if (a && b)
  {
    ...
    (b->left == a) ? (Set_Edge_Dirs(b, a, d, NULL))
...
{
  b->pars_l = (int *)mCalloc(tree->data->n_pattern, sizeof(int));
  b->ui_l   = (int *)mCalloc(tree->data->n_pattern, sizeof(int));
  b->p_pars_l =
      (int *)mCalloc(tree->data->n_pattern * tree->mod->ns, sizeof(int));
...
{
  b->pars_r = (int *)mCalloc(tree->data->n_pattern, sizeof(int));
  b->ui_r   = (int *)mCalloc(tree->data->n_pattern, sizeof(int));
  b->p_pars_r =
      (int *)mCalloc(tree->data->n_pattern * tree->mod->ns, sizeof(int));
...
void Make_Edge_Lk(t_edge *b, t_tree *tree)
{
   ...
   * *)&b->Pij_rr,BYTE_ALIGN,(size_t)tree->mod->ras->n_catg*tree->mod->ns*tree->mod->ns*sizeof(phydbl)))
   * Generic_Exit(__FILE__,__LINE__,__FUNCTION__); */
  /*   if(posix_memalign((void
   * *)&b->tPij_rr,BYTE_ALIGN,(size_t)tree->mod->ras->n_catg*tree->mod->ns*tree->mod->ns*sizeof(phydbl)))
   * Generic_Exit(__FILE__,__LINE__,__FUNCTION__); */
  /* #else */
  /*   b->Pij_rr =
   * _aligned_malloc(tree->mod->ras->n_catg*tree->mod->ns*tree->mod->ns*sizeof(phydbl),BYTE_ALIGN);
   */
  /*   b->tPij_rr =
   * _aligned_malloc(tree->mod->ras->n_catg*tree->mod->ns*tree->mod->ns*sizeof(phydbl),BYTE_ALIGN);
   */
  ...
  /* #else */
  /*   b->Pij_rr = (phydbl
   * *)mCalloc(tree->mod->ras->n_catg*tree->mod->ns*tree->mod->ns,sizeof(phydbl));
   */
  /*   b->tPij_rr = (phydbl
   * *)mCalloc(tree->mod->ras->n_catg*tree->mod->ns*tree->mod->ns,sizeof(phydbl));
   */
  ...
  tree->big_lk_array_pos +=
      tree->mod->ras->n_catg * tree->mod->ns * tree->mod->ns;
...
void Make_Edge_Lk_Left(t_edge *b, t_tree *tree)
{
  ...
  b->sum_scale_left_cat = (int *)mCalloc(
      MAX(tree->mod->ras->n_catg, tree->mod->n_mixt_classes), sizeof(int));

  if (b->left && !b->left->tax)
    b->sum_scale_left =
        (int *)mCalloc(tree->data->n_pattern * MAX(tree->mod->ras->n_catg,
                                                    tree->mod->n_mixt_classes),
                       sizeof(int));
  else
  ...
  if (b->left)
  {
    if ((!b->left->tax) || (tree->mod->s_opt->greedy))
    {
      ...
      /* #ifndef WIN32 */
      /*           if(posix_memalign((void
       * **)&b->p_lk_left,BYTE_ALIGN,(size_t)tree->data->n_pattern*MAX(tree->mod->ras->n_catg,tree->mod->n_mixt_classes)*tree->mod->ns*sizeof(phydbl)))
       * Generic_Exit(__FILE__,__LINE__,__FUNCTION__); */
      /* #else */
      /*           b->p_lk_left =
       * _aligned_malloc(tree->data->n_pattern*MAX(tree->mod->ras->n_catg,tree->mod->n_mixt_classes)*tree->mod->ns*sizeof(phydbl),BYTE_ALIGN);
       */
      /* #endif */
      /* #else */
      /*           b->p_lk_left = (phydbl
       * *)mCalloc(tree->data->n_pattern*MAX(tree->mod->ras->n_catg,tree->mod->n_mixt_classes)*tree->mod->ns,sizeof(phydbl));
       */
      /* #endif */
    ...
    else if (b->left->tax)
    {
     ...
     defined(__SSE2__) || defined(__SSE3__))
      ...
      if (posix_memalign((void **)&b->p_lk_tip_l, BYTE_ALIGN,
        ...
        Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
#else
      b->p_lk_tip_l = _aligned_malloc(
          tree->data->n_pattern * tree->mod->ns * sizeof(phydbl), BYTE_ALIGN);
#endif
#else
      b->p_lk_tip_l = (phydbl *)mCalloc(tree->data->n_pattern * tree->mod->ns,
                                        sizeof(phydbl));
#endif
    }
  }
  ...
  if (b->num >= 2 * tree->n_otu - 3)
  {
    ...
    tree->big_lk_array_pos +=
        tree->data->n_pattern *
        MAX(tree->mod->ras->n_catg, tree->mod->n_mixt_classes) * tree->mod->ns;
  }

  b->patt_id_left = (int *)mCalloc(tree->data->n_pattern, sizeof(int));
}
...
void Make_Edge_Lk_Rght(t_edge *b, t_tree *tree)
{
  ...
  b->sum_scale_rght_cat = (int *)mCalloc(
      MAX(tree->mod->ras->n_catg, tree->mod->n_mixt_classes), sizeof(int));
  ...
  if (b->rght)
  {
    if ((!b->rght->tax) || (tree->mod->s_opt->greedy))
    {
      ...
      /* #ifndef WIN32 */
      /* 	  if(posix_memalign((void
       * **)&b->p_lk_rght,BYTE_ALIGN,(size_t)tree->data->n_pattern*MAX(tree->mod->ras->n_catg,tree->mod->n_mixt_classes)*tree->mod->ns*sizeof(phydbl)))
       * Generic_Exit(__FILE__,__LINE__,__FUNCTION__); */
      /* #else */
      /*           b->p_lk_rght =
       * _aligned_malloc(tree->data->n_pattern*MAX(tree->mod->ras->n_catg,tree->mod->n_mixt_classes)*tree->mod->ns*sizeof(phydbl),BYTE_ALIGN);
    ...
    else if (b->rght->tax)
    {
     ...
     defined(__SSE2__) || defined(__SSE3__))
      ...
      if (posix_memalign((void **)&b->p_lk_tip_r, BYTE_ALIGN,
        ...
        Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
#else
      b->p_lk_tip_r = _aligned_malloc(
          tree->data->n_pattern * tree->mod->ns * sizeof(phydbl), BYTE_ALIGN);
#endif
#else
      b->p_lk_tip_r = (phydbl *)mCalloc(tree->data->n_pattern * tree->mod->ns,
                                        sizeof(phydbl));
#endif
      b->p_lk_rght = NULL;
    }
  ...
  b->patt_id_rght = (int *)mCalloc(tree->data->n_pattern, sizeof(int));
}
...
void Make_Extra_Edge_Lk(t_tree *tree)
{
  ...
  tree->sum_scale_cat_extra_0 = (int *)mCalloc(
      MAX(tree->mod->ras->n_catg, tree->mod->n_mixt_classes), sizeof(int));

  tree->sum_scale_extra_0 =
      (int *)mCalloc(tree->data->n_pattern *
                         MAX(tree->mod->ras->n_catg, tree->mod->n_mixt_classes),
                     sizeof(int));
  ...
  if (posix_memalign(
          ...
          (size_t)tree->data->n_pattern *
              MAX(tree->mod->ras->n_catg, tree->mod->n_mixt_classes) *
              tree->mod->ns * sizeof(phydbl)))
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
#else
  tree->p_lk_extra_0 = _aligned_malloc(
      tree->data->n_pattern *
          MAX(tree->mod->ras->n_catg, tree->mod->n_mixt_classes) *
          tree->mod->ns * sizeof(phydbl),
      BYTE_ALIGN);
#endif
#else
  tree->p_lk_extra_0 = (phydbl *)mCalloc(
      tree->data->n_pattern *
          MAX(tree->mod->ras->n_catg, tree->mod->n_mixt_classes) *
          tree->mod->ns,
      sizeof(phydbl));
  ...
  if (posix_memalign((void **)&tree->p_lk_tip_extra_0, BYTE_ALIGN,
    ...
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
#else
  tree->p_lk_tip_extra_0 = _aligned_malloc(
      tree->data->n_pattern * tree->mod->ns * sizeof(phydbl), BYTE_ALIGN);
#endif
#else
  tree->p_lk_tip_extra_0 =
      (phydbl *)mCalloc(tree->data->n_pattern * tree->mod->ns, sizeof(phydbl));
#endif

  tree->patt_id_extra_0 = (int *)mCalloc(tree->data->n_pattern, sizeof(int));

  tree->div_post_pred_extra_1 = (short int *)mCalloc(ns, sizeof(short int));

  tree->sum_scale_cat_extra_1 = (int *)mCalloc(
      MAX(tree->mod->ras->n_catg, tree->mod->n_mixt_classes), sizeof(int));

  tree->sum_scale_extra_1 =
      (int *)mCalloc(tree->data->n_pattern *
                         MAX(tree->mod->ras->n_catg, tree->mod->n_mixt_classes),
                     sizeof(int));
  ...
  if (posix_memalign(
    ...
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
#else
  tree->p_lk_extra_1 = _aligned_malloc(
      tree->data->n_pattern *
          MAX(tree->mod->ras->n_catg, tree->mod->n_mixt_classes) *
          tree->mod->ns * sizeof(phydbl),
      BYTE_ALIGN);
#endif
#else
  tree->p_lk_extra_1 = (phydbl *)mCalloc(
      tree->data->n_pattern *
          MAX(tree->mod->ras->n_catg, tree->mod->n_mixt_classes) *
          tree->mod->ns,
      sizeof(phydbl));
  ...
  if (posix_memalign((void **)&tree->p_lk_tip_extra_1, BYTE_ALIGN,
    ...
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
#else
  tree->p_lk_tip_extra_1 = _aligned_malloc(
      tree->data->n_pattern * tree->mod->ns * sizeof(phydbl), BYTE_ALIGN);
#endif
#else
  tree->p_lk_tip_extra_1 =
      (phydbl *)mCalloc(tree->data->n_pattern * tree->mod->ns, sizeof(phydbl));
#endif

  tree->patt_id_extra_1 = (int *)mCalloc(tree->data->n_pattern, sizeof(int));
}
...
{
  b->p_lk_loc_rght = (int *)mCalloc(tree->data->n_pattern, sizeof(int));
}
...
{
  b->p_lk_loc_left = (int *)mCalloc(tree->data->n_pattern, sizeof(int));
}
...
t_tree *Make_Tree_From_Scratch(int n_otu, calign *data)
{
...
#ifdef BEAGLE
  // offset the branch's partial indices because BEAGLE insists on first storing
  // the tips/taxa
  ...
  for (i = 0; i < 2 * tree->n_otu - 1; ++i)
  {
    ...
    tree->a_edges[i]->p_lk_left_idx =
        tree->n_otu + tree->a_edges[i]->p_lk_left_idx;
    // For edgeX, its "right" partial lies at index `num_tax + edgeX->num +
    // num_branches"
    tree->a_edges[i]->p_lk_rght_idx =
        tree->n_otu + tree->a_edges[i]->p_lk_left_idx + num_branches;
  }
#endif
...
t_tree *Make_Tree(int n_otu)
{
  ...
  tree->t_dir =
      (short int *)mCalloc((2 * n_otu - 2) * (2 * n_otu - 2), sizeof(int));
  return tree;
}
...
void Make_All_Tree_Nodes(t_tree *tree)
{
  ...
  for (i = 0; i < 2 * tree->n_otu - 1; ++i)
  {
    ...
    if (i < tree->n_otu)
      tree->a_nodes[i]->tax = YES;
    else
      tree->a_nodes[i]->tax = NO;
  }
}
...
void Make_All_Tree_Edges(t_tree *tree)
{
  ...
  for (i = 0; i < 2 * tree->n_otu - 1; ++i)
    tree->a_edges[i] = (t_edge *)Make_Edge_Light(NULL, NULL, i);
}

//////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////

calign *Make_Calign(int n_otu, int n_pattern, int state_len, int init_len,
                    char **sp_names_in, int n_rm, char **sp_names_out)
{
  calign *cdata;
  int     j;
  ...
  cdata->wght          = (phydbl *)mCalloc(n_pattern, sizeof(phydbl));
  cdata->ambigu        = (short int *)mCalloc(n_pattern, sizeof(short int));
  cdata->invar         = (short int *)mCalloc(n_pattern, sizeof(short int));
  ...
  for (j = 0; j < n_otu; j++)
  {
    ...
    cdata->c_seq[j]->name =
        (char *)mCalloc((int)(strlen(sp_names_in[j]) + 1), sizeof(char));
    strcpy(cdata->c_seq[j]->name, sp_names_in[j]);
    cdata->c_seq[j]->state =
        (char *)mCalloc(n_pattern * state_len + 1, sizeof(char));
    cdata->c_seq[j]->d_state =
        (short int *)mCalloc(n_pattern * state_len, sizeof(short int));
    cdata->c_seq[j]->is_ambigu =
        (short int *)mCalloc(n_pattern, sizeof(short int));
  }

  for (j = 0; j < n_rm; j++)
  {
    cdata->c_seq_rm[j] = (align *)mCalloc(1, sizeof(align));
    cdata->c_seq_rm[j]->name =
        (char *)mCalloc((int)(strlen(sp_names_out[j]) + 1), sizeof(char));
    strcpy(cdata->c_seq_rm[j]->name, sp_names_out[j]);
    cdata->c_seq_rm[j]->state =
        (char *)mCalloc(n_pattern * state_len + 1, sizeof(char));
    cdata->c_seq_rm[j]->d_state =
        (short int *)mCalloc(n_pattern * state_len, sizeof(short int));
    cdata->c_seq_rm[j]->is_ambigu =
        (short int *)mCalloc(n_pattern, sizeof(short int));
  }
...
void Make_Custom_Model(t_mod *mod)
{
  ...
  if (!mod->r_mat->rr_num->v)
    mod->r_mat->rr_num->v =
        (int *)mCalloc(mod->ns * (mod->ns - 1) / 2, sizeof(int *));

  if (!mod->r_mat->n_rr_per_cat->v)
    mod->r_mat->n_rr_per_cat->v =
        (int *)mCalloc(mod->ns * (mod->ns - 1) / 2, sizeof(int));
}
...
void Make_Model_Complete(t_mod *mod)
{
  ...
  if (posix_memalign((void **)&mod->Pij_rr->v, BYTE_ALIGN,
    ...
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
#else
  mod->Pij_rr->v = _aligned_malloc(
      mod->ras->n_catg * mod->ns * mod->ns * sizeof(phydbl), BYTE_ALIGN);
#endif
#else
  mod->Pij_rr->v =
      (phydbl *)mCalloc(mod->ras->n_catg * mod->ns * mod->ns, sizeof(phydbl));
#endif

  mod->eigen = (eigen *)Make_Eigen_Struct(mod->ns);

  // If r_mat (e_frq) are not NULL, then they have been created elsewhere and
  // affected.
  if (!mod->r_mat)
  {
...
void Make_RAS_Complete(t_ras *ras)
{
  if (!ras->gamma_r_proba->v)
  {
    ...
    ras->gamma_r_proba_unscaled->v =
        (phydbl *)mCalloc(ras->n_catg, sizeof(phydbl));
...
eigen *Make_Eigen_Struct(int ns)
{
  ...
  if (posix_memalign((void **)&eig->r_e_vect, BYTE_ALIGN,
                     ns * ns * sizeof(phydbl)))
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
  if (posix_memalign((void **)&eig->l_e_vect, BYTE_ALIGN,
                     ns * ns * sizeof(phydbl)))
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
  if (posix_memalign((void **)&eig->dum, BYTE_ALIGN, ns * ns * sizeof(phydbl)))
    Generic_Exit(__FILE__, __LINE__, __FUNCTION__);
#else
...
void Make_Spr_List_One_Edge(t_tree *tree)
{
  ...
  tree->spr_list_one_edge =
      (t_spr **)mCalloc(2 * tree->n_otu - 2, sizeof(t_spr *));
...
t_time *TIMES_Make_Time_Struct(int n_otu)
{
  ...
  if (n_otu > 0)
  {
    ...
    times->times_partial_proba =
        (phydbl *)mCalloc(n_otu * n_otu, sizeof(phydbl));
...
t_rate *RATES_Make_Rate_Struct(int n_otu)
{
  ...
  if (n_otu > 0)
  {
    ...
    rates->cov_l =
        (phydbl *)mCalloc((2 * n_otu - 2) * (2 * n_otu - 2), sizeof(phydbl));
    rates->invcov =
        (phydbl *)mCalloc((2 * n_otu - 2) * (2 * n_otu - 2), sizeof(phydbl));
    ...
    rates->lca =
        (t_node **)mCalloc((2 * n_otu - 1) * (2 * n_otu - 1), sizeof(t_node *));
    rates->reg_coeff =
        (phydbl *)mCalloc((2 * n_otu - 2) * (2 * n_otu - 2), sizeof(phydbl));
    rates->trip_reg_coeff =
        (phydbl *)mCalloc((2 * n_otu - 2) * (6 * n_otu - 9), sizeof(phydbl));
    rates->trip_cond_cov =
        (phydbl *)mCalloc((2 * n_otu - 2) * 9, sizeof(phydbl));
    ...
    rates->cur_gamma_prior_mean =
        (phydbl *)mCalloc(2 * n_otu - 1, sizeof(phydbl));
    rates->cur_gamma_prior_var =
        (phydbl *)mCalloc(2 * n_otu - 1, sizeof(phydbl));
...
void GEO_Make_Geo_Complete(int ldscape_sz, int n_dim, int n_tax, t_geo *t)
{
  ...
  t->idx_loc_beneath =
      (int *)mCalloc((int)(2 * n_tax - 1) * ldscape_sz, sizeof(int));
...
void PHYREX_Make_Lindisk_Next(t_ldsk *t)
{
  ...
  if (t->n_next == 0)
    ...
    t->next = (t_ldsk **)mRealloc(t->next, t->n_next + NEXT_BLOCK_SIZE,
                                  sizeof(t_ldsk *));

  t->n_next++;
  /* PhyML_Printf("\n. make next for ldsk %s n_next set to %d [%p]
   * %d",t->coord->id,t->n_next,t->next,NEXT_BLOCK_SIZE); */
}
                        ...
                        short unsigned **min_dist_edge, int **cluster_sizes)
{
  ...
  (*min_dist)  = (short unsigned *)malloc(
      nb_edges * sizeof(short unsigned)); /* array of min Hamming distances */
  (*min_dist_edge) = (short unsigned *)malloc(
      nb_edges * sizeof(short unsigned)); /* array of edge ids corresponding to
                                             min Hamming distances */
  (*cluster_sizes) = (int *)malloc(
      nb_edges * sizeof(int)); /* array of sizes of clusters associated to each
                                  branch (in the post order traversal) */
  (*c_matrix) = (short unsigned **)malloc(
      nb_edges *
      sizeof(short unsigned *)); /* matrix of cardinals of complements */
  (*i_matrix) = (short unsigned **)malloc(
      nb_edges *
      sizeof(short unsigned *)); /* matrix of cardinals of intersections */
  (*hamming) = (short unsigned **)malloc(
      nb_edges * sizeof(short unsigned *)); /* matrix of Hamming distances */
  for (i = 0; i < nb_edges; i++)
  {
    (*c_matrix)[i] =
        (short unsigned *)malloc(nb_edges * sizeof(short unsigned));
    (*i_matrix)[i] =
        (short unsigned *)malloc(nb_edges * sizeof(short unsigned));
...
{
  // (# of edges) X (# of sites) X (# mutation types: A<->C A<->G A<->T C<->G
  // C<->T G<->T)
  do
  {
    tree->mutmap = (int *)mCalloc((2 * tree->n_otu - 3) * (tree->data->n_pattern) * 6,
                                  sizeof(int));
    tree         = tree->next_mixt;
  } while (tree);
}
...
void Make_Contmod(t_tree *tree)
{
  ...
  tree->contmod->mu_down =
      (phydbl *)mCalloc(n_nodes * n_char * n_dim, sizeof(phydbl));
  tree->contmod->var_down =
      (phydbl *)mCalloc(n_nodes * n_char * n_dim, sizeof(phydbl));
  tree->contmod->logrem_down =
      (phydbl *)mCalloc(n_nodes * n_char * n_dim, sizeof(phydbl));
  ...
  tree->contmod->var_up =
      (phydbl *)mCalloc(n_nodes * n_char * n_dim, sizeof(phydbl));
  tree->contmod->logrem_up =
      (phydbl *)mCalloc(n_nodes * n_char * n_dim, sizeof(phydbl));

  tree->contmod->lnL_up =
      (phydbl *)mCalloc(n_nodes * n_char * n_dim, sizeof(phydbl));
  tree->contmod->lnL_down =
      (phydbl *)mCalloc(n_nodes * n_char * n_dim, sizeof(phydbl));
  tree->contmod->lnL = (phydbl *)mCalloc(4, sizeof(phydbl));

  tree->contmod->obs_var =
      (phydbl *)mCalloc(2 * tree->mmod->n_dim, sizeof(phydbl));
