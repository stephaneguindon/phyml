...
"\t\t the occurence of the different amino-acids in the alignment.\n",FLAT,LINE,FLAT);
  ...
  PhyML_Printf("%s\t\t- %sNucleotide%s sequences: the equilibrium base frequencies are determined by the model (e.g., 1/4 for JC69)  \n",FLAT,LINE,FLAT);
...
"\t\t the frequencies defined by the substitution model.\n",FLAT,LINE,FLAT);
  PhyML_Printf("\n");
  PhyML_Printf("\t\t%so%s : the character frequencies are optimized using maximum likelihood \n",LINE,FLAT);
  PhyML_Printf("\n");
