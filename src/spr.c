          ...
          do
            {
              ...
              tree->mod->s_opt->min_diff_lk_move = MAX(1.E-1,tree->mod->s_opt->min_diff_lk_move);
              tree->mod->s_opt->min_diff_lk_local = MAX(1.E-1,tree->mod->s_opt->min_diff_lk_local);
